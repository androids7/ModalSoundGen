...
/////////////////////////////////////////////////////////////////
CompFab::IndexVoxelGrid *g_index_voxelGrid;
/////////////////////////////////////////////////////////////////
...
extern void kernel_wrapper(int samples, int w, int h, int d, CompFab::VoxelGrid *g_voxelGrid, CompFab::IndexVoxelGrid *g_index_voxelGrid, std::vector<CompFab::Triangle> triangles, bool double_thick);
...
int main(int argc, char *argv[])
{
	...
	kernel_wrapper(args->samples, args->size, args->size, args->size, g_voxelGrid, g_index_voxelGrid, g_triangleList, args->double_thick);
