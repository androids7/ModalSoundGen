...
///////////////////////////////////////////////////////////////////////////////
//Grid structure for Voxels
CompFab::IndexVoxelGridStruct::IndexVoxelGridStruct(Vec3 lowerLeft, unsigned int dimX, unsigned int dimY, unsigned int dimZ, precision_type spacing)
{
    m_lowerLeft = lowerLeft;
    m_dimX = dimX;
    m_dimY = dimY;
...
CompFab::IndexVoxelGridStruct::~IndexVoxelGridStruct()
{
    delete[] m_insideArray;
}
